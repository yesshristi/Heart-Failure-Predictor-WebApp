...
def clean_data(raw_df):     
    ...
    try:
        ...
        print("Custom Error: dropping columns not executed!!")
...
def predict_individual():
    ...
    main_df = sample_df._append(clean_df, ignore_index=True)
...
def predict_multiple():
    ...
    main_df = clean_df.reindex(columns=main_cols, fill_value=0)
    main_df = main_df.fillna(0)
    print("MAIN DATAFRAME")
    print(main_df)
    print(main_df.info())
    ...
    try:
        ...
        print("Custom Error: dropping 'id' column from 'main_df' not executed!!")
